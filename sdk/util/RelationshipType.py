...
class RelationshipType(Enum): 
  ...
  OPERATOR = "operator"
  POSITION_PLAYED_ON_TEAM_/_SPECIALITY = "position played on team / speciality"
  WINNER = "winner"
  ...
  WORK_PERIOD_(START) = "work period (start)"
  ...
  CROSSES = "crosses"
  DISSOLVED,_ABOLISHED_OR_DEMOLISHED_DATE = "dissolved, abolished or demolished date"
  BASED_ON = "based on"
