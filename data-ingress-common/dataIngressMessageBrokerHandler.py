...
class DataIngressMessageBrokerHandler(AbstractMessageBrokerHandler):
    ...
    def __init__(self, 
                 ...
                 default_inbound_event = None, 
                 default_outbound_event=os.getenv("KAFKA_DATA_INGRESS_SERVICE_NEW_UNSTRUCTED_DATA_EVENT", "new-unstructed-data"), #outbound_topic,
        ...
        super().__init__(
                    ...
                    default_inbound_event = default_inbound_event if default_inbound_event != None else build_inbound_topic_list(
                            os.getenv("KAFKA_PIPELINE_CONTROLER_SERVICE","pipeline-controller"),
                            [os.getenv("KAFKA_PIPELINE_CONTROLER_SERVICE_SEARCH_GENERATED_EVENT","searchGenerated")],
                            environment
                        ) + build_inbound_topic_list(
                            os.getenv('KAFKA_GRAPH_EXPANSION_SERVICE','graphExpansion'),
                            [os.getenv("KAFKA_GRAPH_EXPANSION_SERVICE_EXPAND_EVENT", "expand")],
                            environment
                        ), 
    ...
    def handleStream(self, message, event=None, tenant=None, correlationId=None, parentId=None):
        ...
        if dataSourceName == self.dataSourceType:
